package com.pedromonteiro.infrastructure.category.persistence;
...
public class CategoryRepositoryTest {
    ...
    public void givenAnInvalidNullName_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.pedromonteiro.infrastructure.category.persistence.CategoryJpaEntity.name";
    ...
    public void givenAnInvalidNullCreatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.pedromonteiro.infrastructure.category.persistence.CategoryJpaEntity.createdAt";
    ...
    public void givenAnInvalidNullUpdatedAt_whenCallsSave_shouldReturnError() {
        ...
        final var expectedMessage = "not-null property references a null or transient value : com.pedromonteiro.infrastructure.category.persistence.CategoryJpaEntity.updatedAt";
